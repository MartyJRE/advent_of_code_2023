fun main() {
    ...
    fun part1(input: List<String>): Int {
        ...
        val totalPossibleWins = ArrayList<Int>()
        for ((time, distance) in times.zip(distances)) {
            ...
            totalPossibleWins.add(possibleWins)
        }
        return totalPossibleWins.reduce { acc, it -> acc * it }
    }
    ...
    val testInput1 = readInputLines("Day06_test_part1")
    check(part1(testInput1) == 288)

    val testInput2 = readInputLines("Day06_test_part2")
